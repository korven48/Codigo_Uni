...
int howMany(const tPlayer player, int space);
int firstAt(const tPlayer player, int space);
int secondAt(const tPlayer player, int space);
int n_bridges(tPlayer player, int &marker1, int &marker2);

void load(tGame &game);
